...
/*
 ...
 //if ((pacs[q[@"custodianOID"]])[@"local"])
 custodianURI=[NSString stringWithFormat:@"http://localhost:%lld",port];
 //else custodianURI=(pacs[q[@"custodianOID"]])[@"custodianglobaluri"];
 ...
 NSString *additionalParameters=(pacs[q[@"custodianOID"]])[@"wadoadditionalparameters"];
